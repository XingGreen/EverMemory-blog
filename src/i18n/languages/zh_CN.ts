...
export const zh_CN: Translation = {
	...
	[Key.musicNoTracks]: "暂无歌曲",
	[Key.musicLoadingHint]: "如果长时间没有加载内容，请手动刷新",
	[Key.musicMyPlaylists]: "我的歌单",
	[Key.musicSubscribedPlaylists]: "收藏歌单",
	...
	[Key.app]: "应用推荐",
	[Key.appDescription]: "我推荐的一些实用应用和工具，希望能对你有所帮助。",
	[Key.searchApp]: "搜索应用...",
	[Key.appNoItems]: "暂无应用推荐",
	[Key.appVisitSite]: "网站链接",
	[Key.appSourceCode]: "GitHub",
	[Key.appNoLink]: "暂无链接",
	[Key.appFree]: "免费",
	[Key.appFreemium]: "免费/付费",
	[Key.appPaid]: "付费",
	[Key.category]: "分类",
	[Key.platform]: "平台",
	...
	[Key.adminSessionsDesc]: "查看在线设备，随时踢掉可疑会话",
	[Key.sessionsCurrent]: "当前设备",
	[Key.sessionsRemembered]: "已记住（7 天）",
	[Key.sessionsKick]: "踢下线",
	[Key.sessionsKickAllOther]: "踢掉其他设备",
	[Key.sessionsEmpty]: "暂无在线会话",
	[Key.sessionsLoadError]: "会话列表加载失败",
	...
	[Key.sessionsKicked]: "已踢下线",
	[Key.sessionsKickedAll]: "已踢掉其他全部设备",
	[Key.sessionsKickFail]: "操作失败",
	[Key.cloudDraftSaved]: "已同步到云端",
	[Key.cloudDraftSyncing]: "正在同步…",
	[Key.cloudDraftFailed]: "云端同步失败",
	[Key.cloudDraftRetry]: "重试",
	...
	[Key.adminSetupTokenVerified]: "令牌验证通过，请设置管理员账号",
	[Key.adminSetupTokenBack]: "重新输入令牌",
	...
	[Key.externalLinkTitle]: "即将跳转",
	[Key.externalLinkSubtitle]: "请确认目标地址是否安全",
	[Key.externalLinkAddressLabel]: "目标地址",
	[Key.externalLinkWarning]:
		"请仔细检查目标地址，确保是您信任的网站。如不确定，请取消跳转。",
	[Key.externalLinkCancel]: "取消",
	[Key.externalLinkConfirm]: "确认跳转",
};
